    ...
    <header className="sticky top-0 z-30 flex h-16 items-center gap-4 border-b border-border bg-card/80 px-6 backdrop-blur">
      ...
      <div className="flex items-center gap-2">
        <Link
          ...
          className="relative flex items-center gap-2 rounded-xl bg-primary/10 px-3 py-2 text-sm font-semibold text-primary hover:bg-primary/15"
        >
        ...
        >
          <Bell className="size-[18px] text-foreground/80" strokeWidth={1.75} />
